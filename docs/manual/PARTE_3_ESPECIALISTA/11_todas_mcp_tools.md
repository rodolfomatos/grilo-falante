...
Referência completa de todas as 40+ ferramentas disponíveis via MCP.
...
| **Chat** 🆕 | grilo_chat_start, grilo_chat_send, grilo_chat_end, grilo_export_session |
...
| **Fontes** | gepeto_create_source, gepeto_get_source, gepeto_create_curator, gepeto_get_curator |
