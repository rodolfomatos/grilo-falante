...
from grilo_admin.routers import users_router, system_router, plugins_router, repositories_router, cycles_router, learning_router, escalations_router, articles_router, ilhas_router, skills_router
...
async def lifespan(app: FastAPI):
    ...
    # Initialize ILHAManager
    from grilo_admin.routers.ilhas import ILHAManager
    ILHAManager.initialize()
    logger.info(f"ILHAManager initialized with {len(ILHAManager._ilhas)} ILHAs")
